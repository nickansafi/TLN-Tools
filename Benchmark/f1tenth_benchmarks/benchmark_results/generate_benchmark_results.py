...
def tinylidar_il_l():
    ...
    print(test_id)
    planner = TinyLidarNet(test_id,1, 0,os.path.abspath(__file__).rpartition("/Benchmark")[0]+'/Benchmark/f1tenth_benchmarks/zarrar/f1_tenth_model_diff_main_noquantized.tflite')
